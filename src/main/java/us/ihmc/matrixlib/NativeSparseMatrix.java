...
import us.ihmc.matrixlib.jni.NativeSparseMatrixImpl;
 ...
 * {@link DMatrixSparseCSC}, the operations on {@code NativeMatrix} are executed in C++ using Eigen
 * leading to significant performance improvement when compared to the regular Java implementation.
 * <p>
 * Note that unlike {@link DMatrixSparseCSC}, the matrix is stored internally in a column-major 1D array
 ...
 * @author Jesper Smith
 */
public class NativeSparseMatrix implements ReshapeMatrix, DMatrix
{
   ...
   final NativeSparseMatrixImpl impl;
   final int[] nz_length = new int[1];
    ...
    */
   public NativeSparseMatrix(int rows, int cols)
   {
      impl = new NativeSparseMatrixImpl(rows, cols);
   }
    ...
    */
   public NativeSparseMatrix(DMatrixSparseCSC matrix)
   {
    ...
    * @param matrix The matrix which is to be copied. This is not modified or saved.
    */
   public NativeSparseMatrix(NativeSparseMatrix matrix)
   {
      this(matrix.getNumRows(), matrix.getNumCols());
      set(matrix);
   }
    ...
    * @param matrix The matrix which is to be copied. This is not modified or saved.
    */
   public void scale(double alpha, DMatrixSparseCSC matrix)
   {
      set(matrix);
      scale(alpha);
   }
    ...
    * @param matrix The matrix which is to be copied. This is not modified or saved.
    */
   public void scale(double alpha, NativeSparseMatrix matrix)
   {
   ...
   {
      if (!impl.set(matrix.nz_values, matrix.nz_rows, matrix.col_idx, matrix.numRows, matrix.numCols, matrix.nz_length))
      {
    ...
    * @param matrix The matrix which is to be copied. This is not modified or saved.
    */
   public void set(NativeSparseMatrix matrix)
   {
   ...
   /**
    * Packs this matrix into a {@code DMatrixSparseCSC}.
    *
   ...
   public void get(DMatrixSparseCSC matrixToPack)
   {
      ...
      matrixToPack.nz_length = nz_length[0];
   }
    ...
    */
   public void add(NativeSparseMatrix a, NativeSparseMatrix b)
   {
    ...
    * @throws IllegalArgumentException if the matrix dimensions are incompatible.
    */
   public void subtract(NativeSparseMatrix a, NativeSparseMatrix b)
   {
    ...
    * @throws IllegalArgumentException if the matrix dimensions are incompatible.
    */
   public void mult(NativeSparseMatrix a, NativeSparseMatrix b)
   {
    ...
    * @throws IllegalArgumentException if the matrix dimensions are incompatible.
    */
   public void mult(double scale, NativeSparseMatrix a, NativeSparseMatrix b)
   {
    ...
    * @throws IllegalArgumentException if the matrix dimensions are incompatible.
    */
   public void multAdd(NativeSparseMatrix a, NativeSparseMatrix b)
   {
    ...
    * @throws IllegalArgumentException if the matrix dimensions are incompatible.
    */
   public void multAddTransA(NativeSparseMatrix a, NativeSparseMatrix b)
   {
    ...
    * @throws IllegalArgumentException if the matrix dimensions are incompatible.
    */
   public void multAddTransB(NativeSparseMatrix a, NativeSparseMatrix b)
   {
    ...
    */
   public void multAddBlock(NativeSparseMatrix a, NativeSparseMatrix b, int rowStart, int colStart)
   {
    ...
    *                        this.
    */
   public void addBlock(NativeSparseMatrix a, int destStartRow, int destStartColumn, int srcStartRow, int srcStartColumn, int numberOfRows, int numberOfColumns,
                        double scale)
   {
    ...
    * @throws IllegalArgumentException if the matrix dimensions are incompatible.
    */
   public void multTransB(NativeSparseMatrix a, NativeSparseMatrix b)
   {
    ...
    * @throws IllegalArgumentException if the matrix dimensions are incompatible.
    */
   public void multTransA(NativeSparseMatrix a, NativeSparseMatrix b)
   {
    ...
    * @throws IllegalArgumentException if the matrix dimensions are incompatible.
    */
   public void multQuad(NativeSparseMatrix a, NativeSparseMatrix b)
   {
    ...
    * @throws IllegalArgumentException if the matrix dimensions are incompatible.
    */
   public void invert(NativeSparseMatrix a)
   {
      if (a == this)
      {
    ...
    * @throws IllegalArgumentException if the matrix dimensions are incompatible.
    */
   public void transpose(NativeSparseMatrix a)
   {
      if (a == this)
      {
    ...
    * @throws IllegalArgumentException if the matrix dimensions are incompatible.
    */
   public void solve(NativeSparseMatrix a, NativeSparseMatrix b)
   {
    ...
    * @throws IllegalArgumentException if the matrix dimensions are incompatible.
    */
   public void insert(NativeSparseMatrix src, int srcY0, int srcY1, int srcX0, int srcX1, int dstY0, int dstX0)
   {
    ...
    * @throws IllegalArgumentException if the matrix dimensions are incompatible.
    */
   public void insert(NativeSparseMatrix src, int dstY0, int dstX0)
   {
    ...
    * @throws IllegalArgumentException if the matrix dimensions are incompatible.
    */
   public void insert(DMatrixSparseCSC src, int srcY0, int srcY1, int srcX0, int srcX1, int dstY0, int dstX0)
   {
      if (!impl.insert(src.col_idx, src.nz_rows, src.nz_values, src.numRows, src.numCols, src.nz_length, srcY0, srcY1, srcX0, srcX1, dstY0, dstX0))
      {
         throw new IllegalArgumentException("Incompatible Matrix Dimensions.");
      }
   }
    ...
    * @throws IllegalArgumentException if the matrix dimensions are incompatible.
    */
   public void insert(DMatrixSparseCSC src, int dstY0, int dstX0)
   {
      insert(src, 0, src.getNumRows(), 0, src.getNumCols(), dstY0, dstX0);
   }
    ...
    */
   public void extract(int srcY0, int srcY1, int srcX0, int srcX1, DMatrixSparseCSC dst, int dstY0, int dstX0)
   {
      if (!impl.extract(srcY0, srcY1, srcX0, srcX1, dst.col_idx, dst.nz_rows, dst.nz_values, nz_length, dst.numRows, dst.numCols, dstY0, dstX0))
      {
         throw new IllegalArgumentException("Incompatible Matrix Dimensions");
      }
      dst.nz_length = nz_length[0];
   }
    ...
    * @throws IllegalArgumentException if the matrix dimensions are incompatible.
    */
   public void extract(DMatrixSparseCSC dst, int dstY0, int dstX0)
   {
    ...
    * {@link #get(DMatrixSparseCSC)} to pack once the data back into Java land if needing to do multiple
    * accesses.
    * </p>
    *
...
//   }
   ...
   // TODO Add doc
   public boolean isApprox(NativeSparseMatrix other, double precision)
   {
    ...
    * {@link MatrixIO#print(PrintStream, DMatrix)}.
    *
   ...
   @Override
   public NativeSparseMatrix copy()
   {
      return new NativeSparseMatrix(this);
   }

   @SuppressWarnings("unchecked")
   @Override
   public NativeSparseMatrix createLike()
   {
      return new NativeSparseMatrix(getNumRows(), getNumCols());
   }

   @SuppressWarnings("unchecked")
   @Override
   public NativeSparseMatrix create(int numRows, int numCols)
   {
      return new NativeSparseMatrix(numRows, numCols);
   }

   /**
    * {@inheritDoc}
    * <p>
    * This implementation only supports {@link NativeSparseMatrix} and {@link DMatrixSparseCSC}.
    * </p>
    * 
   ...
   {
      if (original instanceof NativeSparseMatrix)
         set((NativeSparseMatrix) original);
